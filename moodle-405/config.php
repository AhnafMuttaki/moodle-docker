...
$CFG->dbname    = getenv('DB_405_NAME') ?: 'moodle405';     // database name, eg moodle
$CFG->dbuser    = 'root';   // your database username
$CFG->dbpass    = getenv('DB_ROOT_PASSWORD') ?: 'changeme';   // your database password
...
$CFG->wwwroot   = getenv('APP_405_WWWROOT') ?: 'http://localhost:405';
...
$CFG->dataroot  = '/var/www/moodledata-405';
...
// Set unique session cookie name for Moodle 4.0.5
$CFG->sessioncookie = '405';
